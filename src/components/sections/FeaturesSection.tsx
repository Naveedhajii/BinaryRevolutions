  ...
  return (
    <section id="features" className="pt-14 sm:pt-20 lg:pt-[130px] fadeIn">
      <div className="container mx-auto px-4">
        <div className="wow fadeInUp relative mx-auto mb-12 max-w-[620px] pt-6 text-center md:mb-20 lg:pt-16" data-wow-delay=".2s">
          ...
          Creativity and Innovation is considered to be the insignia of Binary Revolutions.
          Here we strive to provide excellent solutions and platforms to newly introduced business with our experienced qualified staff.
          </p>
        </div>
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".2s">
              ...
              <div>
                <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white">Crafted for Saas Business</h3>
                <p className="text-dark-text text-base">Designed specifically for SaaS companies, our solutions focus on performance, scalability, and user experience to help your business grow efficiently.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".25s">
              <div className="bg-primary/5 text-primary group-hover:bg-primary dark:group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white group-hover:opacity-100 md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:opacity-100">
                <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current">
              ...
              <div>
                <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white">Web Development</h3>
                <p className="text-dark-text text-base">Technology on its own cannot deem a website successful. It takes skilled and experienced web developers to structure a sound website that functions smoothly.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".3s">
              <div className="bg-primary/5 text-primary group-hover:bg-primary dark:group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white group-hover:opacity-100 md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:opacity-100">
                <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current">
              ...
              <div>
                <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white">Mobile Apps</h3>
                <p className="text-dark-text text-base">Our online applications provide tailored eCommerce solutions allowing a rapid development and deployment of your requirement.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".35s">
              <div className="bg-primary/5 text-primary group-hover:bg-primary dark:group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white group-hover:opacity-100 md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:opacity-100">
                <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current">
              ...
              <div>
                <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white">IT Consultancy</h3>
                <p className="text-dark-text text-base">In simple words, you can outsource your IT infrastructure and we will manage, implement, deploy and administer your entire IT environment.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".4s">
              <div className="bg-primary/5 text-primary group-hover:bg-primary dark:group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white group-hover:opacity-100 md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:opacity-100">
                <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current">
              ...
              <div>
                <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white">Off Shore Dev</h3>
                <p className="text-dark-text text-base">Binary Revolutions always focus on providing qualitative, timely delivered and cost-effective Offshore Software Development services.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto max-w-[380px] text-center md:mb-16" data-wow-delay=".45s">
              <div className="bg-primary/5 text-primary group-hover:bg-primary dark:group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white group-hover:opacity-100 md:mb-9 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white dark:group-hover:opacity-100">
                <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current">
              ...
              <div>
                <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-5 dark:text-white">Regular Updates</h3>
                <p className="text-dark-text text-base">We ensure your platform stays current with frequent updates that improve performance, security, and features.</p>
              </div>
            </div>
          </div>
        </div>
