...
const SlickSlide = ({ children, className, style }: SlickSlideProps) => {
  const filteredProps = { className, style };
    ...
    <section id="testimonial" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2
            className="font-heading text-dark mx-auto mb-5 max-w-[450px] text-3xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-white"
          >
        ...
        <div className="w-full px-4">
          <div
            className="wow fadeInUp drop-shadow-light relative z-10 overflow-hidden rounded-sm bg-cover bg-center px-10 pt-[60px] pb-28 sm:px-14 md:p-[70px] md:pb-28 lg:pb-[70px] dark:drop-shadow-none rounded-xl shadow-sm transition-all duration-300"
            data-wow-delay=".3s"
          >
            <div
              className="bg-noise-pattern absolute top-0 left-0 -z-10 h-full w-full bg-cover bg-center opacity-10 dark:opacity-40 pointer-events-none"
            ></div>
            ...
            <div className="relative z-10">
                      ...
                      <div className="-mx-4 flex flex-wrap items-center">
                        <div className="order-last w-full px-4 lg:order-first lg:w-1/2">
                          <div className="text-center lg:text-left">
                            <p
                              className="font-heading text-dark-text mb-9 text-base font-light lg:text-lg xl:text-2xl dark:text-gray-400"
                            >
                              " {testimonial.text} "
                            </p>
                            <h3
                              className="font-heading text-dark mb-1 text-xl dark:text-white"
                            >
                              {testimonial.name}
                            </h3>
                        ...
                        <div className="w-full px-4 lg:w-1/2">
                          <div
                            className="relative mx-auto mb-9 h-[420px] w-full max-w-[420px] lg:mr-0 lg:mb-0"
                          >
                            <Image
                            ...
                            />
                            <div
                              className="border-primary/10 bg-primary/5 absolute -top-5 -right-5 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                            ></div>
                          </div>
              ...
              <div className="flex justify-center mt-6 gap-4 z-20">
                <button
                  type="button"
                  aria-label="Previous testimonial"
                  className="rounded-full bg-primary p-3 text-white shadow hover:bg-primary/80 transition pointer-events-auto"
